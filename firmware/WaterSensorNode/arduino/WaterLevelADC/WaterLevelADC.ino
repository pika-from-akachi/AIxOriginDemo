...
// Sensor VCC -> 3V3, GND -> GND, OUT -> GPIO5 (ADC1_CH4).
// Verify the module supports 3.3V. GPIO5 is NOT GPIO51.
...
void setup() {
  ...
  Serial.println("raw12_avg,raw_min,raw_max,efuse_mV,corrected_mV,sd_mV,level_pct,status");
}
...
void loop() {
  ...
  Serial.printf("%.2f,%u,%u,%.2f,%.2f,%.2f,",rawAvg,rawMin,rawMax,efuseMV,mv,sd);
